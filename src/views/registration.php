		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Criar Conta</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-12">
						...
						<div class="row no-gutters">
							<div class="col-md-7">
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<form method="POST" action="../src/models/process_registration.php" id="contactForm" name="contactForm" class="contactForm">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="label" for="username">Nome Completo</label>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="phone" class="form-control" name="phone" id="phone" placeholder="Telefone" required>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label class="label" for="petname">Nome do Pet</label>
													<input type="petname" class="form-control" name="petname" id="petname" placeholder="Nome do Pet" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
